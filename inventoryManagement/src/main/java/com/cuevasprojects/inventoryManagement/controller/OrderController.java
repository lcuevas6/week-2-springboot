package com.cuevasprojects.inventoryManagement.controller;
...
import com.cuevasprojects.inventoryManagement.service.OrderService;
...
public class OrderController {
	...
	public ResponseEntity<Object> udpateOrder(@RequestBody Order order, @PathVariable Long orderId){
		try {
