...
import com.cuevasprojects.inventoryManagement.service.CustomerService;
...
public class CustomerController {
	...
	public ResponseEntity<Object> updateCustomer(@RequestBody Customer customer, @PathVariable Long id){
		try {
			return new ResponseEntity<Object>(service.updateCustomer(customer, id), HttpStatus.CREATED);
		}catch (Exception e) {
			return new ResponseEntity<Object>(e.getMessage(), HttpStatus.NOT_FOUND);
		}
	}
